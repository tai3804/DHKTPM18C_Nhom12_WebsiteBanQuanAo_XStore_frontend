            ...
            <div className="space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-12">
                <div className="space-y-4">
                  <div className="p-3 bg-gray-100 rounded-sm w-fit">
                ...
                <div className="space-y-4">
                  ...
                  <h3 className="text-xl font-medium text-gray-900">Đổi Mới</h3>
                  <p className="text-gray-600 font-light leading-relaxed">
                ...
                <div className="space-y-4">
                  ...
                  <h3 className="text-xl font-medium text-gray-900">Tận Tâm</h3>
                  <p className="text-gray-600 font-light leading-relaxed">
