                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-6 text-center lg:text-left">
                        ...
                        <p className="text-xl text-gray-600 max-w-md mx-auto lg:mx-0">
                            Khám phá bộ sưu tập thời trang mới nhất, đa dạng phong cách và chất liệu cao cấp tại X-Store.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <button className="bg-blue-600 text-white hover:bg-blue-700 h-10 px-8 rounded-md">Mua Ngay</button>
                            <button className="h-10 px-8 border border-gray-300 rounded-md hover:bg-gray-50">Xem Bộ Sưu Tập</button>
                        </div>
                    </div>
                    ...
                    <div className="relative hidden lg:block">
                        ...
                        <div className="absolute -bottom-6 -right-6 bg-white border border-gray-200 rounded-xl p-4 shadow-lg">
                            <p className="text-sm font-medium text-gray-900">Bộ Sưu Tập Mới</p>
